...
public class testng_demo1 {
    ...
    @Test(description = "test3", priority = 3, timeOut = 8000, dataProvider = "otherdata", dataProviderClass = Params.class)
    ...
    @Test(description = "test5", priority = 4, timeOut = 5000, dataProvider = "get_data_from_excel", dataProviderClass = Params.class)
